import { issueSponsorship, type KmsP256Key, kmsP256Signer } from "@kippurocks/sponsorship";
 ...
 *
 * It issues real sponsorships in `@kippurocks/sponsorship`'s format, so the path a
