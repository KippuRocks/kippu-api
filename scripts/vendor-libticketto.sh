#!/usr/bin/env bash
# Vendors @ticketto/sdk and @ticketto/profile-v0 from a pinned libticketto commit, as
...
#   scripts/vendor-libticketto.sh --check    rebuild at the recorded commit and fail if the
