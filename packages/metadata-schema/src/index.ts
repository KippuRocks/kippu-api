/**
 * `@kippurocks/metadata-schema` — the `C6` contract.
 *
 ...
 *
 * The schema files themselves are exported too, as `@kippurocks/metadata-schema/event/1.0.json`
 * and `@kippurocks/metadata-schema/class/1.0.json`.
 */
